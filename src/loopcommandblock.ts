module Marmot {
    ...
    export class LoopCommandBlock extends CommandBlock {
        ...
        public updateBackgroundSetting(): void {
            this.backgroundSetting.pathBackground = [
                ...
                ["lineTo", this.myWidth, 15 * Block.blockSetting.blockScale],
                ["arcTo", (this.myWidth + 7 * Block.blockSetting.blockScale) , 15 * Block.blockSetting.blockScale, (this.myWidth + 7 * Block.blockSetting.blockScale) , 17 * Block.blockSetting.blockScale, 2 * Block.blockSetting.blockScale],
                ["arcTo", (this.myWidth + 7 * Block.blockSetting.blockScale) , 35 * Block.blockSetting.blockScale, (this.myWidth + 5 * Block.blockSetting.blockScale), 35 * Block.blockSetting.blockScale, 2 * Block.blockSetting.blockScale],
                ["lineTo", this.myWidth, 35 * Block.blockSetting.blockScale],
            ...
            this.backgroundSetting.hitAreaBackground = [
                0 * Block.blockSetting.blockScale, 0 * Block.blockSetting.blockScale,
                this.myWidth, 0 * Block.blockSetting.blockScale,
                this.myWidth, 15 * Block.blockSetting.blockScale,
                (this.myWidth + 7 * Block.blockSetting.blockScale) , 15 * Block.blockSetting.blockScale,
                (this.myWidth + 7 * Block.blockSetting.blockScale) , 35 * Block.blockSetting.blockScale,
                this.myWidth, 35 * Block.blockSetting.blockScale,
